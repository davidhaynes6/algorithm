...
// helper function for parellel_matrix_multiply
void parallel_worker(
    long** A, size_t num_rows_a, size_t num_cols_a,
    long** B, size_t num_rows_b, size_t num_cols_b,
